...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="assets/images/employeezonelogo.png">
        ...
        <div class="login-box card">
            <div class="card-body loginpage">
                ...
                <form class="form-horizontal form-material" method="post" id="loginform" action="login/Login_Auth">
                    <a href="javascript:void(0)" class="text-center db"><br/><img src="<?php echo base_url(); ?>assets/images/employeezonelogo.png" width="240px" alt="Home" /></a>
